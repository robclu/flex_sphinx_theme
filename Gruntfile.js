module.exports = function(grunt) {
  ...
  grunt.initConfig({
        ...
        files: [
          {
              ...
              dest: 'flex_sphinx_theme/static/fonts/FreightSans',
              filter: 'isFile'
          },

          {
              ...
              dest: 'flex_sphinx_theme/static/fonts/IBMPlexMono',
              filter: 'isFile'
          }
        ]
      },
        ...
        files: [
          {
              ...
              flatten: true,
              src: ['images/*'],
              dest: 'flex_sphinx_theme/static/images',
              filter: 'isFile'
          }
        ]
      },
      ...
      vendor: {
        files: [
...

          {
            ...
            dest: 'flex_sphinx_theme/static/js/vendor',
            filter: 'isFile'
          }
        ]
      }
    ...
    sass: {
      dev: {
        ...
        files: [{
          ...
          cwd: 'scss',
          src: ['*.scss'],
          dest: 'flex_sphinx_theme/static/css',
          ext: '.css'
        }]
      },
      build: {
    ...
    postcss: {
      ...
      dist: {
        files: {
          "flex_sphinx_theme/static/css/theme.css": "flex_sphinx_theme/static/css/theme.css"
        }
      }
    },
    ...
    browserify: {
      dev: {
        ...
        src: ['js/*.js'],
        dest: 'flex_sphinx_theme/static/js/theme.js'
      },
      build: {
        options: {
          external: ['jquery'],
    ...
    uglify: {
      dist: {
        ...
        files: [{
          expand: true,
          src: ['flex_sphinx_theme/static/js/*.js', '!flex_sphinx_theme/static/js/*.min.js'],
          dest: 'flex_sphinx_theme/static/js/',
    ...
    clean: {
      build: ["docs/build"],
      fonts: ["flex_sphinx_theme/static/fonts"],
      images: ["flex_sphinx_theme/static/images"],
      css: ["flex_sphinx_theme/static/css"],
      js: ["flex_sphinx_theme/static/js/*", "!flex_sphinx_theme/static/js/modernizr.min.js"]
    },
    ...
    watch: {
      ...
      sphinx: {
        files: ['flex_sphinx_theme/**/*', 'README.rst', 'docs/**/*.rst', 'docs/**/*.py'],
